      ...
      <div class="row mt-4">
        <div class="col-6">
            <form action="" method="GET">
              ...
              <input type="text" class="form-control" name="keyword" id="keyword" autocomplete="off" placeholder="Masukkan keyword pencarian.." autofocus><button class="btn btn-primary" type="submit" id="cari" name="cari">Cari!</button>
            </div>
            </form>
        </div>
      </div>
